...
body {
	background: #7f9b4e url(/images/bg.jpg);
...
<script type="text/javascript">
            ...
            function login() {
                ...
                var action = "login";
                // 异步网络请求
                ajaxCallBack("IndexServlet", {action:action,username:username,passwd:passwd}, function(data){
                	if (data.info == "0") {
                        $.messager.alert("提示", '用户名或密码错误！');
                    } else {
                       	alert("登陆成功!");
                       	// 进入主页
                        window.location.href = __APP__+"IndexServlet";
                    }
                }, null, true);
            }
