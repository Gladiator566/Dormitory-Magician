            ...
            if (roletype == "1") {
                _menus = {
                    "menus": [
                        ...
                        {"menuid": "10", "icon": "icon-role", "menuname": "二手车管理",
                            "menus": [
                                {"menuid": "122", "menuname": "在售二手车列表", "icon": "icon-users", "url": __APP__+"pages/Car/car.jsp"}
                            ]
...
<div region="south" split="true"
	...
	<div region="north" hide="true" split="true">
	  ...
	  <div class="logo">
	    ...
	    <h1 style="font-size:25px;margin-top:15px;width:350px;">二手车拍卖系统后台管理</h1>
	  </div>
	</div>
	</div>
